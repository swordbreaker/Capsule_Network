#form  https://github.com/xieliaing/keras-practice/blob/master/fashion-mnist/VGGlike.py 
import numpy as np
...
train_image_url = "VGG_Like/train-images-idx3-ubyte.gz"
train_label_url = "VGG_Like/train-labels-idx1-ubyte.gz"
test_image_url = "VGG_Like/t10k-images-idx3-ubyte.gz"
test_label_url = "VGG_Like/t10k-labels-idx1-ubyte.gz"
...
model3fit = model3.fit(X_train, Y_train2, validation_data=(X_test, Y_test2), batch_size=500, verbose=1, epochs=16)
